...
public class UpdateEmployee implements Operation{
	...
	public void oper(Database database, Scanner scanner) {
		...
		System.out.println("Enter FirstName (-1 to keep"+employee.getFirstName()+"):");
		String firstName=scanner.next();
		if(!firstName.equals("-1"))employee.setFirstName(firstName);
		System.out.println("Enter LastName (-1 to keep"+employee.getLastName()+"):");
		String lastName=scanner.next();
		if(!lastName.equals("-1"))employee.setLastName(lastName);
		
		System.out.println("Enter Email (-1 to keep"+employee.getEmail()+"):");
		String email=scanner.next();
		if(!email.equals(employee.getEmail())) employee.setEmail(email);
		...
		System.out.println("Enter Password (-1 to keep"+employee.getPassword()+"$ ):");
